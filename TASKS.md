...
- **Критерий приемки (E1–E3):** Unit-тесты с моками проверяют создание ящика, таймаут ожидания письма, регулярные выражения для OTP (4-8 цифр) и ссылок активации.
...
- **Критерий приемки (E1–E3):** Перехватчик запускает браузер, слушает сетевые запросы, отфильтровывает картинки, CSS и внешнюю аналитику, сохраняя структурированный лог запросов отправки форм.

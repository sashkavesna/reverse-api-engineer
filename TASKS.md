...
- **Критерий приемки (E1–E3):** Корректное выделение эндпоинта отправки формы, сопоставление полей (login, email, password), поиск CSRF-токена в предшествующих GET-ответах и формирование валидного JSON-рецепта `ServiceRecipe` (4/4 тестов зеленые).
